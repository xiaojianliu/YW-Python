...
# find gaps
    ...
    """    
    FN2=DESTINDIR+FN
    np.savez(FN2,tdh=tdh,tgap=tgap,flag=flag,londh=londh,latdh=latdh,udh=udh,vdh=vdh,udm=udm,vdm=vdm,udti=udti,vdti=vdti,umoh=umoh,vmoh=vmoh,umom=umom,vmom=vmom,umoti=umoti,vmoti=vmoti)
