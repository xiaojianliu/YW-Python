...
dfeobs=pd.read_csv('BF01botttemp_da_obs.csv',sep=',',parse_dates={'datet':[0,1,2]},index_col='datet',date_parser=parse,names=['yy','mm','dd','count','mean','median','min','max','std','rms'])
...
dfnobs=pd.read_csv('I01botttemp_da_obs.csv',sep=',',parse_dates={'datet':[0,1,2]},index_col='datet',date_parser=parse,names=['yy','mm','dd','count','mean','median','min','max','std','rms'])
...
dfeom=pd.read_csv('BF01botttemp_da_mod_da_obs.csv',sep=',',skiprows=1,parse_dates=True,index_col=[0],names=['date','mean','median','min','max','std','rms'])
dfnom=pd.read_csv('I01botttemp_da_mod_da_obs.csv',sep=',',skiprows=1,parse_dates=True,index_col=[0],names=['date','mean','median','min','max','std','rms'])
